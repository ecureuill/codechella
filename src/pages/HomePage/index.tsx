	...
	return (
		<>
			...
			<div className='main-wrapper'>
				...
				<Text variant='paragraph' size='largest'>System of a DOM</Text>
				<Text variant='paragraph' size='medium' className='flex-column'>
					<span>Python Maiden</span> 
					<span>Apollo Client 2001</span>
					<span>Bon Java</span>
					<span>NickCallback</span>
				</Text>
				<Text variant='paragraph' size='small' className='flex-column'>
					<span>Linkin Promises</span>
					<span>Fullstack Fighters</span>
					<span>Papa React</span>
					<span>Angular in Chains</span>
				</Text>
				<Text variant='paragraph' size='tiny' className='flex-column'>
				...
				<Text variant='paragraph' size='large'>Lana Del Ploy</Text>
				<Text variant='paragraph' size='medium' className='flex-column'>
					<span>Dua Lib</span>
